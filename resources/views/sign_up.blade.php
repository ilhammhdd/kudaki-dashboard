            ...
            <div class="row">
                <div class="col-12">
                    <div class="section-header text-left">
                        <h2 class="section-title wow fadeInDown" data-wow-delay="0.3s">Sign Up form</h2>
                    </div>
                </div>
            </div>

            <form id="sign-up" method="post" action="{{route('auth.signUp')}}">
                @csrf
                <div class="form-group row">
                    <label for="example-text-input" class="col-2 col-form-label">Nama Lengkap</label>
                    <div class="col-6">
                        <input class="form-control" type="text" value="" id="full-name" name="full_name">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-6">
                        <input class="form-control" type="tel" value="" id="phone-number" name="phone_number">
                    </div>
                </div>
                ...
                <input type="text" value="ORGANIZER" id="role" name="role" hidden>
